...
export default function Explanation3() {
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-500/30 p-4 rounded-xl mb-4">
                    ...
                    <div className="bg-white p-4 rounded-lg">
                        ...
                        <p className="text-xs text-gray-600 mt-2 text-right" dir="rtl">
                            ...
                            לדוגמה 651.500 הנקודה שלנו היא 651924. כשנחשוב על הנקודה כמו ציר נחשוב: 651ץ924 נמקם את הנקודה הזו על הציר שלנו:
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-pink-500/30 p-4 rounded-xl mb-4">
                    ...
                    <div className="bg-white p-4 rounded-lg">
                        <svg viewBox="0 0 600 500" className="w-full">
                            {/* Top diagram */}
                            <g>
                                <line x1="200" y1="50" x2="200" y2="150" stroke="#ef4444" strokeWidth="2" />
                                <line x1="400" y1="50" x2="400" y2="150" stroke="#000" strokeWidth="2" />
                                <line x1="150" y1="100" x2="450" y2="100" stroke="#ef4444" strokeWidth="2" />
                                <line x1="150" y1="50" x2="450" y2="50" stroke="#000" strokeWidth="2" />

                                <text x="200" y="170" textAnchor="middle" fontSize="16" fontWeight="bold">651</text>
                                <text x="400" y="170" textAnchor="middle" fontSize="16">652</text>
                                <text x="130" y="105" textAnchor="middle" fontSize="16" fontWeight="bold">407</text>
                                <text x="130" y="55" textAnchor="middle" fontSize="16">408</text>

                                <circle cx="200" cy="100" r="6" fill="#3b82f6" stroke="#fff" strokeWidth="2" />
                                <circle cx="384" cy="62" r="6" fill="#fbbf24" stroke="#fff" strokeWidth="2" />
                                <circle cx="400" cy="100" r="6" fill="#fbbf24" stroke="#fff" strokeWidth="2" />
                            </g>

                            {/* Bottom diagram with final point */}
                            <g transform="translate(0, 200)">
                                <line x1="200" y1="50" x2="200" y2="250" stroke="#ef4444" strokeWidth="2" />
                                <line x1="400" y1="50" x2="400" y2="250" stroke="#000" strokeWidth="2" />
                                <line x1="150" y1="100" x2="450" y2="100" stroke="#ef4444" strokeWidth="2" />
                                <line x1="150" y1="50" x2="450" y2="50" stroke="#000" strokeWidth="2" />

                                <text x="200" y="270" textAnchor="middle" fontSize="16" fontWeight="bold">651</text>
                                <text x="400" y="270" textAnchor="middle" fontSize="16">652</text>
                                <text x="130" y="105" textAnchor="middle" fontSize="16" fontWeight="bold">407</text>

                                <circle cx="200" cy="100" r="6" fill="#3b82f6" stroke="#fff" strokeWidth="2" />
                                <circle cx="384" cy="186" r="6" fill="#fbbf24" stroke="#fff" strokeWidth="2" />

                                {/* Dashed line connecting points */}
                                <line x1="384" y1="62-200" x2="384" y2="186" stroke="#666" strokeWidth="2" strokeDasharray="5,5" />

                                {/* Final red point */}
                                <circle cx="384" cy="186" r="8" fill="#ef4444" stroke="#fff" strokeWidth="2" />

                                <text x="420" y="190" fontSize="12" fontWeight="bold" fill="#ef4444">651924/407375</text>
                            </g>


                        </svg>
                        <p className="text-xs text-gray-600 mt-2 text-right" dir="rtl">
                            הנקודה שנוצרה לנו היא הנ.צ
                        </p>
                    </div>
                </div>
